...
void main() {
  test('type graph report includes resolved and generated entries', () {
    ...
    final generatedDrops = (data['generatedDrops'] as List).cast<String>();
    ...
    expect(generatedDrops.contains('GeneratedGestureTapCallbackDrop'), isTrue);
    expect(totalSkipped, 0);
