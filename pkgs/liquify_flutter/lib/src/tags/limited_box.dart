...
class LimitedBoxTag extends WidgetTagBase with CustomTagParser, AsyncTag {
  LimitedBoxTag(super.content, super.filters);
  ...
  dynamic evaluateWithContext(Evaluator evaluator, Buffer buffer) {
    ...
    try {
      ...
      buffer.write(_buildLimitedBox(evaluator.context, config, children));
    } finally {
  ...
  _LimitedBoxConfig _parseConfig(Evaluator evaluator) {
    final config = _LimitedBoxConfig();
