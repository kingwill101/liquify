...
void registerFlutterTags({Environment? environment}) {
  ...
  if (generatedOnly) {
    _registerTag('lua', (content, filters) => LuaTag(content, filters),
        environment);
  }
  if (!generatedOnly) {
    registerGeneratedTags(environment);
  _registerTag('row', (content, filters) => RowTag(content, filters),
      environment);
  _registerTag('column', (content, filters) => ColumnTag(content, filters),
      environment);
  _registerTag('container',
      (content, filters) => ContainerTag(content, filters), environment);
  _registerTag(
      'child', (content, filters) => ChildTag(content, filters), environment);
  _registerTag('margin', (content, filters) => MarginTag(content, filters),
      environment);
  _registerTag('padding', (content, filters) => PaddingTag(content, filters),
      environment);
  _registerTag('alignment',
      (content, filters) => AlignmentTag(content, filters), environment);
  _registerTag(
      'fade_transition',
      (content, filters) => FadeTransitionTag(content, filters),
      environment);
  _registerTag('hero', (content, filters) => HeroTag(content, filters),
      environment);
  _registerTag(
      'scaffold', (content, filters) => ScaffoldTag(content, filters),
      environment);
  _registerTag(
      'app_bar', (content, filters) => AppBarTag(content, filters), environment);
  _registerTag('bottom_app_bar',
      (content, filters) => BottomAppBarTag(content, filters), environment);
  _registerTag('drawer', (content, filters) => DrawerTag(content, filters),
      environment);
  _registerTag(
      'size', (content, filters) => SizeTag(content, filters), environment);
  _registerTag('background',
      (content, filters) => BackgroundTag(content, filters), environment);
  _registerTag(
      'decorated_box',
      (content, filters) => DecoratedBoxTag(
          DecorationPosition.background, 'decorated_box', content, filters),
      environment);
  _registerTag(
      'foreground_decorated_box',
      (content, filters) => DecoratedBoxTag(
          DecorationPosition.foreground, 'foreground_decorated_box', content, filters),
      environment);
  _registerTag(
      'shader_mask',
      (content, filters) => ShaderMaskTag(content, filters),
      environment);
  _registerTag('breakpoint',
      (content, filters) => BreakpointTag(content, filters), environment);
  _registerTag('card', (content, filters) => CardTag(content, filters),
      environment);
  _registerTag('alert_dialog',
      (content, filters) => AlertDialogTag(content, filters), environment);
  _registerTag(
      'simple_dialog',
  ...
  _registerTag(
      ...
      environment);
  _registerTag('snackbar', (content, filters) => SnackBarTag(content, filters),
      environment);
  _registerTag('snack_bar',
      (content, filters) => SnackBarTag(content, filters), environment);
  _registerTag(
      'snack_bar_action',
      (content, filters) => SnackBarActionTag(content, filters),
      environment);
  _registerTag('bottom_sheet',
      (content, filters) => BottomSheetTag(content, filters), environment);
  _registerTag(
  ...
  _registerTag('lua', (content, filters) => LuaTag(content, filters),
      environment);
  _registerTag('segmented',
      (content, filters) => SegmentedControlTag(content, filters), environment);
  _registerTag('segmented_control',
      (content, filters) => SegmentedControlTag(content, filters), environment);
  _registerTag('toggle_buttons',
      (content, filters) => ToggleButtonsTag(content, filters), environment);
  _registerTag(
  ...
  _registerTag(
      ...
      environment);
  _registerTag('date_picker',
      (content, filters) => DatePickerTag(content, filters), environment);
  _registerTag('time_picker',
      (content, filters) => TimePickerTag(content, filters), environment);
  _registerTag(
      'time_picker_dialog',
  ...
  _registerTag(
      ...
      environment);
  _registerTag('tabs', (content, filters) => TabsTag(content, filters),
      environment);
  _registerTag('tab', (content, filters) => TabTag(content, filters),
      environment);
  _registerTag(
      'tab_bar',
  ...
  _registerTag(
      ...
      environment);
  _registerTag(
      'text', (content, filters) => TextTag(content, filters), environment);
  _registerTag(
      'selectable_text',
      (content, filters) => SelectableTextTag(content, filters),
      environment);
  _registerTag('chip', (content, filters) => ChipTag.chip(content, filters),
      environment);
  _registerTag(
  ...
  _registerTag(
      ...
      environment);
  _registerTag('input_chip',
      (content, filters) => ChipTag.input(content, filters), environment);
  _registerTag(
      'badge', (content, filters) => BadgeTag(content, filters), environment);
  _registerTag(
      'avatar', (content, filters) => AvatarTag(content, filters), environment);
  _registerTag('button', (content, filters) => ButtonTag(content, filters),
      environment);
  _registerTag(
      'elevated_button',
      (content, filters) => MaterialButtonTag(
          MaterialButtonVariant.elevated, 'elevated_button', content, filters),
      environment);
  _registerTag(
      'outlined_button',
      (content, filters) => MaterialButtonTag(
          MaterialButtonVariant.outlined, 'outlined_button', content, filters),
      environment);
  _registerTag(
      'filled_button',
      (content, filters) => MaterialButtonTag(
          MaterialButtonVariant.filled, 'filled_button', content, filters),
      environment);
  _registerTag(
      'icon_button',
      (content, filters) => IconButtonTag(
          IconButtonVariant.standard, 'icon_button', content, filters),
      environment);
  _registerTag(
      'icon_button_filled',
      (content, filters) => IconButtonTag(
          IconButtonVariant.filled, 'icon_button_filled', content, filters),
      environment);
  _registerTag(
      'icon_button_filled_tonal',
      (content, filters) => IconButtonTag(IconButtonVariant.filledTonal,
          'icon_button_filled_tonal', content, filters),
      environment);
  _registerTag(
      'icon_button_outlined',
      (content, filters) => IconButtonTag(
          IconButtonVariant.outlined, 'icon_button_outlined', content, filters),
      environment);
  _registerTag(
  ...
  _registerTag(
      ...
      environment);
  _registerTag(
      'spacer', (content, filters) => SpacerTag(content, filters), environment);
  _registerTag('slider', (content, filters) => SliderTag(content, filters),
      environment);
  _registerTag('checkbox',
      (content, filters) => CheckboxTag(content, filters), environment);
  _registerTag('radio', (content, filters) => RadioTag(content, filters),
      environment);
  _registerTag('progress',
  ...
  _registerTag(
      ...
      environment);
  _registerTag('list_tile',
      (content, filters) => ListTileTag(content, filters), environment);
  _registerTag(
      'checkbox_list_tile',
  ...
  _registerTag(
      ...
      environment);
  _registerTag('icon', (content, filters) => IconTag(content, filters),
      environment);
  _registerTag(
  ...
  _registerTag(
      ...
      environment);
  _registerTag(
      'form', (content, filters) => FormTag(content, filters), environment);
  _registerTag(
      'form_field',
      (content, filters) => FormFieldTag(content, filters),
      environment);
  _registerTag(
      'scroll_view', (content, filters) => ScrollViewTag('scroll_view', content, filters),
      environment);
  _registerTag(
      'single_child_scroll_view',
      (content, filters) => ScrollViewTag('single_child_scroll_view', content, filters),
      environment);
  _registerTag(
      'custom_scroll_view',
  ...
  _registerTag(
      ...
      environment);
  _registerTag(
      'switch', (content, filters) => SwitchTag(content, filters), environment);
  _registerTag('list', (content, filters) => ListTag('list', content, filters),
      environment);
  _registerTag(
  ...
  _registerTag(
      'reorderable_list',
      (content, filters) => ReorderableListTag('reorderable_list', content, filters),
      environment);
  _registerTag(
  ...
  _registerTag(
      ...
      environment);
  _registerTag('grid', (content, filters) => GridTag('grid', content, filters),
      environment);
  _registerTag(
      'grid_view', (content, filters) => GridTag('grid_view', content, filters),
      environment);
  _registerTag(
      'table', (content, filters) => TableTag(content, filters), environment);
  _registerTag(
      'data_table',
  ...
  _registerTag(
      ...
      environment);
  _registerTag(
      'image', (content, filters) => ImageTag(content, filters), environment);
  _registerTag(
      'bottom_nav', (content, filters) => BottomNavTag('bottom_nav', content, filters),
      environment);
  _registerTag(
      'bottom_navigation_bar',
      (content, filters) => BottomNavTag('bottom_navigation_bar', content, filters),
      environment);
  _registerTag(
      'bottom_nav_item',
