...
void main() {
  ...
  group('Arithmetic operators', () {
    ...
    test('Multiplication operator (*)', () {
      final multiplication = BinaryOperation(
        Literal(6, LiteralType.number),
        '*',
        Literal(7, LiteralType.number),
      );
  ...
  group('Comparison operators', () {
    ...
    test('Greater than or equal operator (>=)', () {
      final greaterEqualTrue1 = BinaryOperation(
        Literal(10, LiteralType.number),
        '>=',
        Literal(5, LiteralType.number),
      );
      ...
      final greaterEqualFalse = BinaryOperation(
        Literal(5, LiteralType.number),
        '>=',
        Literal(10, LiteralType.number),
      );
    ...
    test('Less than or equal operator (<=)', () {
      final lessEqualTrue1 = BinaryOperation(
        Literal(5, LiteralType.number),
        '<=',
        Literal(10, LiteralType.number),
      );
      ...
      final lessEqualFalse = BinaryOperation(
        Literal(10, LiteralType.number),
        '<=',
        Literal(5, LiteralType.number),
      );
  ...
  group('Logical operators', () {
    test('AND operator', () {
      ...
      final andFalse1 = BinaryOperation(
        Literal(true, LiteralType.boolean),
        'and',
      ...
      final andFalse2 = BinaryOperation(
        Literal(false, LiteralType.boolean),
        'and',
        Literal(true, LiteralType.boolean),
      );
      ...
      final andFalse3 = BinaryOperation(
        Literal(false, LiteralType.boolean),
        'and',
        Literal(false, LiteralType.boolean),
      );
    ...
    test('NOT operator', () {
      final notTrue = UnaryOperation(
        'not',
        Literal(false, LiteralType.boolean),
      );
      expect(evaluator.evaluate(notTrue), true);

      final notFalse = UnaryOperation(
        'not',
        Literal(true, LiteralType.boolean),
      );
    ...
    test('Truthy values in logical operators', () {
      ...
      final truthyString = BinaryOperation(
      ...
      final truthyNumber = BinaryOperation(
      ...
      final falsyString = BinaryOperation(
      ...
      // Zero is falsy
      final falsyNumber = BinaryOperation(
      ...
      // Null is falsy
      final falsyNull = BinaryOperation(
        Literal(null, LiteralType.nil),
        'and',
        Literal(true, LiteralType.boolean),
      );
