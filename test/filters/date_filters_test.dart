...
void main() {
  ...
  group('Date Filters', () {
    ...
    test('date filter handles DateTime inputs', () {
      expect(date(DateTime(2023, 05, 15), ['yyyy-MM-dd'], {}),
          equals('2023-05-15'));
    });
    ...
    test('date_to_xmlschema filter', () {
      ...
      expect(dateToXmlschema('2023-01-15', [], {}),
    ...
    test('date_to_long_string filter', () {
      ...
      expect(dateToLongString('2023-05-15', ['ordinal', 'US'], {}),
          equals('May 15th, 2023'));
      expect(dateToLongString('2023-11-11', ['ordinal', 'US'], {}),
